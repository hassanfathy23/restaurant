...
export default function Testimonials() {
  return (
    <div className="mt-48 flex flex-col lg:flex-row gap-20 justify-evenly items-center">
      <div className="relative w-full lg:w-[610px] h-[406px]">
        <Image src="/images/clip-waiting.png" alt="image" fill />
      </div>
      <div className="w-full lg:w-[510px] flex flex-col gap-6">
        <p className=" text-[#EC6083] font-medium text-[18px]">what they say</p>
        <h2 className="w-full md:w-7/12 lg:w-full font-bold text-[48px] leading-none">
          what our customer say about us
        </h2>
        <p className="w-full md:w-10/12 lg:w-full text-black/70">
